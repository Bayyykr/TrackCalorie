                    ...
                    <div class="post-footer">
                        <div class="post-stats">
                            ...
                            <div class="views-stat">
                                ...
                                <span
                                    id="views-count-{{ $post->id }}">{{ number_format($post->views_count ?? 0) }}
                                    Views</span>
                            </div>
                        ...
                        <div class="activity-content">
                            <div class="activity-text">
                                @if ($activity->type === 'post')
                                    <span class="highlight">{{ $activity->user->name ?? 'Unknown User' }}</span> posted a
                                    new question: 
                                    <a href="{{ route('forum.answer', ['post' => $activity->id]) }}" class="activity-link">{{ Str::limit($activity->title, 30) }}</a>
                                @elseif ($activity->type === 'answer')
                                    <span class="highlight">{{ $activity->user->name ?? 'Unknown User' }}</span>
                                    answered a question: 
        ...
        <div class="modal-content-forum">
            ...
            <form id="questionForm" class="question-form">
                ...
                <div class="form-group">
                    <input type="text" id="questionTitle" class="form-control" placeholder="Question Title"
                        required>
                </div>
                ...
                <div class="form-group">
                    <textarea id="questionContent" class="form-control" placeholder="Enter your question details here!" rows="4"
                        required></textarea>
                </div>
