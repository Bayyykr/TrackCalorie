    ...
    <div class="content answer-content">
        ...
        <div class="question">
            <div class="question-header">
                {{-- Gunakan avatar_url yang sudah diproses --}}
                @php
                ...
                <div class="question-meta">
                    ...
                    <div class="question-date">Asked June 20, 2025 <span class="question-tag">Build Muscle Mass</span>
                    </div>
                </div>
            </div>
        ...
        <div class="answer">
            <div class="answer-header">
                @php
                $answerUserAvatar = isset($answer->user->avatar_url) ? $answer->user->avatar_url :
                asset('images/default-avatar.png');
                $answerUserName = isset($answer->user->name) ? $answer->user->name : 'Deleted User';
                @endphp
                <img src="{{ $answerUserAvatar }}" alt="{{ $answerUserName }}" class="avatar">
                <div class="answer-meta">
                    <div class="answer-author">{{ $answerUserName }}</div>
                    <div class="answer-date">Asked June 20, 2025 <span class="question-tag">Build Muscle Mass</span>
                    </div>
                </div>
            </div>
        ...
        <form action="{{ route('forum.answer.store') }}" method="POST" class="response-box" id="answerForm">
            ...
            <textarea class="response-input" name="content" placeholder="Enter your response here!" rows="1"
